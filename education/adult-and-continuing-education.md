...
description: Adult and continuing education includes learning opportunities for people beyond traditional school settings.
published: true
...
### For Neurodivergent Adults (ADHD, autism, dyslexia, etc.)
...
### For Multiply-Marginalized Adults
...
### Funding Across Global Contexts
...
### Disability-Led Learning in the Global South
...
1. **Identify your access needs:** What helps you learn? (flexibility, captions, quiet space, movement breaks, etc.)
2. **Explore options:** What programs fit your needs, interests, schedule, and budget?
3. **Contact disability services early:** Before you enroll if possible
4. **Request specific accommodations:** With examples and reasoning
5. **Build community:** Connect with other disabled students and learners
6. **Plan for success:** What support do you need? What backup plans do you have?
7. **Advocate:** If accommodations aren't provided, know your rights and seek support
