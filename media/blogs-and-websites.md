...
- **Disability Studies Quarterly** (dsq-sds.org) – Open-access academic journal.

- **Journal of Literary & Cultural Disability Studies** – Academic publication.
...
- **Parent Center Hub** (parentcenterhub.org) – Information for parents of disabled children.

- **Family Voices** (familyvoices.org) – Family advocacy.

- **PEAK Parent Center** – Inclusive education resources.
...
- **Ouch! (BBC)** – BBC disability blog, archived.

- **Ragged Edge** – Disability rights magazine archive.

- **Disability Social History Project** – Historical resources.

- **Planet of the Blind** – Stephen Kuusisto's blog (now less active).

---

## How to Evaluate Disability Websites

**Questions to ask:**

1. **Who runs it?** Disability-led organization? Disabled writers? Parent organization? Charity?

2. **What language is used?** Identity-first? Person-first? "Special needs"? "Suffers from"?

3. **Who benefits?** Does money/attention go to disabled people or to non-disabled "helpers"?

4. **What's the framing?** Tragedy and cure? Or rights and culture?

5. **Are disabled people quoted?** Or talked about?
...
1. **Prioritize disabled writers and disability-led organizations**
2. **Note who runs the site** (disabled-led, parent-led, charity, etc.)
3. **Include URL**
...
*This page centers disabled writers and disability-led organizations.*
