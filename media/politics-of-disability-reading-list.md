...
This is a curated entry point, not the full catalog. For the complete lists, see **[Books](/media/books)** (memoir, fiction, poetry, kids) and the project **[Bibliography](/glossary/bibliography)** (academic and primary sources).

---

## How to use this list

- **Own voices first.** Where an author's lived disability is self-disclosed, we say so. That's a feature of this field, not a quota — the field-defining texts are overwhelmingly by disabled, Mad, Deaf, chronically ill, and neurodivergent writers.
...
*Welcoming, plain-spoken, own-voices. If you read nothing else, read these.*
...
*The core argument: disability is administered into being. Read these to see how law, the economy, and knowledge systems draw the line.*
...
*Branch into the domain most relevant to your community.*
...
Two kinds of pairing make this list sharper:
...
Domains that are easy to miss, and where this pathway deliberately points outward:

- **Deaf literature & "Deaf gain"** — Bauman & Murray, eds., *Deaf Gain* (2014); John Lee Clark, *Touch the Future* (2023, DeafBlind/Protactile). *Own voices.* Deaf community frameworks often diverge from "disability" framing and deserve their own shelf — see [Deaf History & Culture](/history/deaf-history-culture).
...
For the fuller, genre-by-genre versions of these — plus poetry, middle-grade, and primary legal documents (the CRPD, the ADA) — see **[Books](/media/books)** and the **[Bibliography](/glossary/bibliography)**.
...
- [Books](/media/books) — the full genre-organized reading list
- [Bibliography](/glossary/bibliography) — academic and primary sources
- [Disability Models](/foundations/disability-models) — medical, social, and political/relational
- [Epistemic Injustice](/foundations/epistemic-injustice) — being disbelieved as a knower
- [History of Disability](/history/index) · [Media Tropes & Representation](/media/media-tropes-and-representation)
