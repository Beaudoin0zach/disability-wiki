...
published: true
date: 2025-11-21T20:06:23.286Z
tags: 
editor: markdown
dateCreated: 2025-11-20T18:58:20.749Z
---
...
- A topic – `wheelchair repair`, `SNAP`, `IEP`, `paratransit`
- A country or region – `Canada`, `UK`, `Philippines`
- A phrase – `"chronic pain"`, `"ADHD"`, `"service animals"`
...
1. **Short overview** – What this topic is and why it matters.
2. **Key points / checklists** – Especially for benefits, legal rights, and practical tasks.
3. **Country- or region-specific info** – Clearly labeled when it only applies to certain places.
4. **Links & resources** – Official sites, community guides, and movement work.
5. **Notes & cautions** – Things like timelines, documentation, or common obstacles.
