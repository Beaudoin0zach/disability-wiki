...
tags: 
editor: markdown
dateCreated: 2026-01-11T19:41:08.056Z
---
...
### How It's Often Misused (In Practice)
...
- Consumer control (disabled people directing their own services)
- Peer support (disabled people supporting each other)
- Advocacy (individual and systemic)
- Barrier removal (physical, attitudinal, institutional)
- Centers for Independent Living (CILs) as community resources
...
## Using These Models in Real Life

You'll encounter different models in different contexts:

- A doctor using the medical model
- A charity ad using the charity/tragedy model
- A disability rights law grounded in the social or human rights model
- A benefits assessment using (or misusing) the biopsychosocial model
- Community organizers working from disability justice
