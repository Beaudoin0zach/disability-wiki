...
description: How disability language works—identity-first vs. person-first, terms the community has reclaimed, words to retire, and why people get to name themselves.
published: true
...
This page is about *language and labels* specifically. For the deeper "am I disabled enough / who counts" questions, see [Disability Identity and Visibility](/foundations/disability-identity); for shared art, humor, and history, see [Disability Culture](/foundations/disability-culture).
