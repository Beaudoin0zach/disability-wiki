...
- **Participate as research subjects**: Surveys, interviews, and studies accommodate diverse access needs

- **Participate as researchers**: Disabled people can conduct, analyze, and disseminate research

- **Access research outputs**: Findings are published in accessible formats

- **Benefit from research**: Studies address issues that matter to disabled communities
...
### Survey Platforms with Accessibility Features
...
- **[Section 508 Guidelines](https://www.section508.gov)**: U.S. federal accessibility standards
...
- **[Section 508: Usability Testing with People with Disabilities](https://www.section508.gov/develop/usability-testing-with-people-with-disabilities/)**: Guidance for inclusive research design
- **[UNSW Doing Research Inclusively Guidelines](https://www.disabilityinnovation.unsw.edu.au/sites/default/files/documents/DIIU%20Doing%20Research%20Inclusively-Guidelines%20%2817%20pages%29.pdf)**: Comprehensive guide to co-production with disabled people
...
- **[W3C Web Accessibility Initiative](https://www.w3.org/WAI/)**: Comprehensive accessibility guidelines
- **[Plain Language Guidelines](https://www.plainlanguage.gov)**: U.S. government plain language resources
- **[Easy Read Guidelines](https://www.inclusioneurope.eu)**: Creating materials for people with intellectual disabilities

### Inclusive Research Guides

- **[National Disability Authority Ethical Guidance](https://nda.ie/publications/ethical-guidance-for-research-with-people-with-disabilities-report)**: Ireland — principles for ethical, accessible research
- **[Fable: How to Get Started with Accessibility Research](https://makeitfable.com/article/how-to-get-started-with-accessibility-research/)**: Practical guidance for digital accessibility research

### Accessible Document Creation

- **[Microsoft Accessibility Resources](https://www.microsoft.com/en-us/accessibility)**: Making Office documents accessible
- **[Adobe Accessibility Resources](https://www.adobe.com/accessibility.html)**: PDF accessibility guidance
