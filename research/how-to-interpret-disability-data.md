...
tags: 
editor: markdown
dateCreated: 2025-11-20T19:13:10.205Z
---
...
1. **Definition**: How was "disability" defined? By diagnosis, functional limitation, self-identification, or other means?

2. **Inclusion**: Who was included in the sample—and who might have been excluded?

3. **Accessibility**: Were accommodations provided (translation, accessible survey tools, etc.)?

4. **Disaggregation**: Is data broken down across relevant demographics?

5. **Framing**: Are findings contextualized? Is language deficit-based or ableist?

6. **Participation**: Were disabled people involved in design, data collection, interpretation, or review?

7. **Benefit**: How will this research benefit disabled communities?
...
- **[UN Guidelines for Disability Statistics](https://unstats.un.org/unsd/methodology/citygroups/washington.cshtml)**: International standards for disability measurement and interpretation
- **[CBM Disability Data Advocacy Toolkit](https://cbm-global.org/resource/disability-data-advocacy-toolkit)**: Guidance on ethical data handling and interpretation
- **[WHO Disability Data Collection Resources](https://www.who.int/activities/collection-of-data-on-disability)**: Model disability surveys and analysis frameworks

### Academic Resources

- McDonald, K.E., Kidney, C.A., & Patka, M. (2013). "'You need to let your voice be heard': Research participants' views on research." *Journal of Intellectual Disability Research* — On involving disabled people in research interpretation
