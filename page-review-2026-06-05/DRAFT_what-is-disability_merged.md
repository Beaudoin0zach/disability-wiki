# Proposed merge: foundations/what-is-disability + start/what-is-disability (DRAFT — review before publishing)

**Plan:** publish the merged content below to **`foundations/what-is-disability`** (the nav-canonical page), then replace **`start/what-is-disability`** with a redirect stub. This keeps foundations' stronger framing and grafts the unique taxonomy/myths sections that only the `start` version had. Both originals are backed up.

Sections taken from `start`: *Disability vs. Difference, Visible vs. Invisible, Temporary/Permanent/Fluctuating, Acquired/Congenital/Age-Related, Common Myths*. Everything else is foundations' existing content (kept as-is). Broken `/start/models`-style links from the original were not carried over.
...
Disability isn't one thing — these distinctions help describe how widely experiences vary. None of them make a disability more or less "real."
...
**Visible disabilities** are apparent to strangers (wheelchair use, guide dog, visible facial difference). Challenges include assumptions and stereotyping, unwanted stares or comments, and sometimes too much unsolicited "help."
...
- **Permanent** disabilities remain stable (blindness, spinal cord injury, amputation)
...
- **Congenital** — present from birth or early development (cerebral palsy, Down syndrome, autism, many vision/hearing disabilities)
...
**Myth:** Disability is always tragic or sad.
...
**Myth:** Disabled people all want to be "fixed."
**Reality:** Some want medical treatment, some don't. Many prioritize social change, accessibility, and acceptance over a medical "cure."

**Myth:** Disability is about individual limitation.
**Reality:** Much of disability is about social barriers — the limitation often comes from inaccessibility, not the person.

**Myth:** All disabled people want the same thing.
**Reality:** Disabled people have diverse needs, desires, and priorities. We are not a monolith.

**Myth:** Disability has to be permanent to count.
**Reality:** Temporary and fluctuating disabilities are real disabilities. Duration doesn't determine validity.
...
### Foundations
- [Disability Models](/foundations/disability-models) — Deeper exploration of the frameworks mentioned here
- [Language, Terminology & Identity](/foundations/language-terminology-identity) — Guidance on specific terms and their histories
- [Disability Culture](/foundations/disability-culture) — How disability becomes community, art, and shared experience
- [For Allies](/foundations/for-allies) — If you're supporting a disabled person

### History
- [History of Disability Rights](/rights/history-of-disability-rights) — Movement history in depth
- [Disability Rights Movement](/history/disability-rights-movement) — Key events and figures
- [Pre-Industrial History](/history/pre-industrial) — Disability before industrialization

### Rights & Legal Definitions
- [Global Overview](/rights/global-overview) — Disability rights worldwide
- [International Rights](/rights/international-rights) — UN CRPD and international frameworks
- [ADA](/rights/us/ada) — Americans with Disabilities Act (US)

### Intersectionality
- [Indigenous Disability Perspectives](/intersectionality/indigenous-disability-perspectives) — Non-Western frameworks
- [Race & Disability](/intersectionality/race-and-disability) — Racial dimensions of disability
- [Poverty & Class](/intersectionality/poverty-and-class) — Economic aspects of disability
- [Immigration & Refugees](/intersectionality/immigration-and-refugees) — Disability and migration

### Specific Conditions
- [Physical Disabilities](/conditions/physical-disabilities) — Mobility and physical differences
- [Sensory Disabilities](/conditions/sensory-disabilities) — Deaf, blind, and sensory differences
- [Chronic Illness](/conditions/chronic-illness) — Ongoing health conditions
- [Neurodivergence](/conditions/neurodivergence) — Neurological differences
- [Invisible Disabilities](/conditions/invisible-disabilities) — Non-apparent disabilities
- [Psychiatric & Psychosocial Disability](/conditions/psychiatric-and-psychosocial-disability) — Mental health conditions
