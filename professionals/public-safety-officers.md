...
tags: 
editor: markdown
dateCreated: 2025-11-20T19:10:30.960Z
---
...
### Recognizing Medical vs. Behavioral
...
1. **Assume disability when behavior seems unusual**. The safest assumption protects everyone.

2. **Time and space de-escalate**. If safe, wait and create distance.

3. **Simple, direct communication**. One officer, one instruction at a time.

4. **Allow processing time**. What looks like defiance may be slow processing.

5. **Reduce sensory input**. Turn off sirens, dim lights, move to calmer spaces.

6. **Never separate people from service animals, mobility devices, or communication tools**.

7. **Ask caregivers and family** if present—they know what helps.

8. **Consider whether police are the right responders**. Sometimes mental health professionals are more appropriate.
