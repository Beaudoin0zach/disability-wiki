---
title: Why People Are Rude About Mobility Aids
description: Mobility aids are freedom, not failure. Why people react strangely to canes, wheelchairs, and walkers—including ambulatory and part-time use—and how to handle it.
published: true
...
Understanding the assumptions makes the comments easier to brush off:
...
- **You don't owe an explanation.** "It helps me, thanks" is a complete answer. So is changing the subject or walking (or rolling) away.
- **Pick your battles.** Some moments are worth educating; many aren't worth your energy. Both choices are fine.
- **Decide disclosure on your terms.** How much you share about why you use an aid is up to you. See [Social Boundaries and Disclosure](/relationships/boundaries-disclosure) and [Handling Intrusive Questions](/foundations/handling-intrusive-questions).
- **Find people who get it.** Other aid users normalize part-time use, fluctuation, and style. See [Disability-Specific Peer Groups](/community/disability-specific-peer-groups).

---

## Related Pages

- [Handling Intrusive Questions](/foundations/handling-intrusive-questions)
- [Disability Identity and Visibility](/foundations/disability-identity)
- [Social Boundaries and Disclosure](/relationships/boundaries-disclosure)
