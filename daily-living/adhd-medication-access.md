...
*Last reviewed: June 2026. This is an evolving situation — shortage status, DEA quotas, and which formulations are short all change frequently. Check the live [FDA](https://www.fda.gov/drugs/drug-safety-and-availability/drug-shortages) and [ASHP](https://www.ashp.org/drug-shortages/current-shortages) shortage databases before relying on any specific availability claim.*
...
No single trick fixes a shortage, but these are the levers people actually use. The recurring themes in expert guidance: **persistence, flexibility, and planning ahead.**

### Pharmacy-hunting
- **Call ahead before you're out** — phone first; don't drive around.
...
Your prescriber may switch you to something in stock. Whether any option fits *you* is a clinical decision. Described neutrally, with no dosing:
...
- **Mail-order pharmacies** (often via insurance) can sometimes supply when retail can't, but Schedule II timing rules make them less flexible in a pinch — plan further ahead.
...
**A gap is hard, and it's not a personal failure.** ADHD is brain-based; if going without your medication makes work and daily tasks harder, that's the medication doing its job — not a lack of effort. Be kind to yourself and lower the bar where you can.
...
It's understandable to feel desperate during a gap. But buying "Adderall" or other stimulants from **online sites that don't require a prescription, social-media sellers, or any non-pharmacy source is genuinely dangerous.** The DEA has warned that illegal online pharmacies ship **counterfeit pills made with fentanyl and methamphetamine**, disguised as real medication — and people have died. These sites are built to look legitimate. The only reliably safe medication is one **prescribed by a licensed provider and dispensed by a real, licensed pharmacy.** If you're at the end of your options, keep working your prescriber and pharmacist, use the resources below, and consider telehealth through *licensed* providers.

---

## Organizations & resources

- **[CHADD](https://chadd.org/)** — major ADHD nonprofit; practical [shortage guidance](https://chadd.org/attention-article/adhd-medication-shortages-what-to-know-and-do/) and support.
- **[ADDA](https://add.org/)** — the leading nonprofit focused specifically on **adults** with ADHD; peer support and resources.
- **[FDA Drug Shortages](https://www.fda.gov/drugs/drug-safety-and-availability/drug-shortages)** — official current US shortage status ([searchable database](https://www.accessdata.fda.gov/scripts/drugshortages/Drugshortages.cfm) — search by active-ingredient name, e.g. "amphetamine").
- **[ASHP Drug Shortages](https://www.ashp.org/drug-shortages/current-shortages)** — pharmacist-oriented tracker, often more granular than FDA.
- **[DEA — Illegal Online Pharmacies](https://www.dea.gov/resources/illegal-online-pharmacies)** — why to avoid non-pharmacy sources.
...
- [Managing Medications in an Inaccessible World](/daily-living/medication-management) · [Neurodivergence](/conditions/neurodivergence)
- [Insurance Navigation](/healthcare/insurance-navigation) · [Mental Health](/healthcare/mental-health)
