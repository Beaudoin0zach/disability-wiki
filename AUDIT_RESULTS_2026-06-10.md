...
### ⏳ OPEN
- [x] discord.md structural fix — rewritten as a genuine Discord page 2026-06-10 (accessibility features verified against discord.com/accessibility + support docs; no named servers listed — churn risk — discovery directories instead). NOTE: es/community/online-communities/discord.md has the same defect (Spanish Reddit content under a Discord title) and still needs the translated rewrite.
...
- [ ] P2 safeguard additions (personal-care abuse pathway, CRPD caveat sweep, GET pathway, HCBS waitlist, research IRB note, directory access-dates) — online-communities scam/predation note + verify-activity note DONE 2026-06-10 (community/online-communities/index.md)
