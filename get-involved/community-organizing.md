...
1. **Identify an issue** impacting your community that you're passionate about

2. **Meet and listen** to people directly affected—one-on-one conversations are foundational

3. **Form a small organizing team** of people ready to commit time and energy

4. **Map your community's power**: Who makes decisions? Who influences them?

5. **Build relationships** with potential allies and coalition partners

6. **Choose winnable demands**: Start with something achievable to build momentum

7. **Take strategic action**: Choose tactics that build power and move toward your goals

8. **Evaluate and repeat**: What worked? What didn't? What's next?
...
### Disabled-Led Organizing

- **[ADAPT](https://adapt.org)**: National direct action disability rights organization
- **[National Council on Independent Living (NCIL)](https://ncil.org)**: Network of Centers for Independent Living
- **[Sins Invalid](https://www.sinsinvalid.org)**: Disability justice performance project
- **[Autistic Self Advocacy Network (ASAN)](https://autisticadvocacy.org)**: Autistic-led organizing

### Learning Resources

- **[Tools for Power: Resource Kit for Independent Living](https://www.independentliving.org/toolsforpower/)**: International guide to organizing and movement building
- **[National Park Service Disability Rights History](https://www.nps.gov/articles/disabilityhistoryrightsmovement.htm)**: Overview of the disability rights movement
...
- [Accessible Protest Guide](/get-involved/accessible-protest-guide)
