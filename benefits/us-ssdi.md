...
## Who SSDI Is For (In Plain Language)
...
3. **Not a Short-Term Disability Program**  
...
## Health Coverage Connection (Medicare)
...
1. Fill out an application describing your work history and conditions.  
2. Provide medical records or sign releases so SSA can request them.  
3. Sometimes attend exams with SSA-contracted doctors.
