...
tags: 
editor: markdown
dateCreated: 2026-01-07T19:59:09.387Z
---
...
1. Confirm eligibility (onset of disability age, documentation).  
2. Choose an ABLE program (state-specific or national options).  
3. Open the account online and designate the account owner (the disabled person).  
4. Decide how funds will be invested (programs often have different investment options).
