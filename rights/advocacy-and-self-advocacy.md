...
tags: 
editor: markdown
dateCreated: 2025-11-20T19:13:43.934Z
---
...
**Jump to:**
- [Understanding Advocacy](#understanding-advocacy)
- [Self-Advocacy Fundamentals](#self-advocacy-fundamentals)
- [Systemic Advocacy](#systemic-advocacy)
- [Resources by Country](#resources-by-country)
...
Advocacy means speaking up—for yourself, for others, or for change. Disabled people have always advocated, though systems have often tried to silence that voice.
...
- Your country's disability laws (see [Global Overview](/rights/global-overview))
...
Steps:
1. Make request to supervisor or HR in writing
2. Propose specific accommodation
3. Be open to interactive process—employer may suggest alternatives
4. If denied, ask for reason in writing
5. Appeal or seek legal assistance if needed
