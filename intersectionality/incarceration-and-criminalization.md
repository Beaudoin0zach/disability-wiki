...
description: Disabled and Deaf people are over-represented in jails and prisons — and they are also leading the organizing to change that. People are more than what is done to them.
published: true
date: 2026-06-05T20:38:36.326Z
tags: 
editor: markdown
dateCreated: 2026-01-07T20:08:18.496Z
---
...
The harm here is a feedback loop: school discipline → arrest → confinement → solitary → *new* disability → reentry without support → re-incarceration. Naming it as a loop is also where organizers find the openings to break it — at every stage, disabled and formerly incarcerated people are leading that work.

---

## Organizations and resources

- **[HEARD](https://behearddc.org/)** — abolitionist, Deaf/disabled-led org supporting Deaf and disabled incarcerated people.
- **[Interrupting Criminalization](https://www.interruptingcriminalization.com/)** — abolitionist research and organizing to end the criminalization of the most-impacted.
- **[Disability Justice Culture Club](https://dj-cultureclub.org/)** — Oakland collective of disabled QTBIPOC organizers.
- **[National Association of the Deaf — Jails & Prisons](https://www.nad.org/resources/justice/jails-and-prisons/rights-of-deaf-and-hard-of-hearing-inmates/)** — rights of Deaf and hard-of-hearing incarcerated people.
- **[Solitary Watch](https://solitarywatch.org/)** — investigative newsroom on solitary confinement, including its disability dimensions.
- **[Bureau of Justice Statistics](https://bjs.ojp.gov/)** — federal source for disability-prevalence data in prisons and jails.
...
- [Psychiatric and Psychosocial Disability](/conditions/psychiatric-and-psychosocial-disability)
- [Abuse, Neglect, and Exploitation](/crisis/abuse-neglect-exploitation) · [Advocacy and Self-Advocacy](/rights/advocacy-and-self-advocacy)
