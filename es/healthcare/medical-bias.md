...
tags: 
editor: markdown
dateCreated: 2026-01-11T19:41:46.293Z
---
...
Esta página ofrece marcos conceptuales. Para estrategias prácticas, consulta [Invalidación médica y trauma en la atención de salud](/es/healthcare/medical-gaslighting).
...
Para una guía detallada sobre estas intersecciones, consulta [Raza y discapacidad](/es/intersectionality/race-and-disability), [Género y discapacidad](/es/intersectionality/gender-and-disability) y [Personas LGBTQ+ y discapacidad](/es/intersectionality/lgbtq-and-disability).
...
- [Invalidación médica y trauma en la atención de salud](/es/healthcare/medical-gaslighting) — Estrategias prácticas para el reconocimiento, la sanación y la autodefensa
- [Derechos en la atención médica](/es/healthcare/healthcare-rights) — Tus derechos legales en entornos médicos
- [Atención médica accesible](/es/healthcare/accessible-healthcare) — Encontrar proveedores que funcionen
- [Defensa de derechos y autodefensa](/es/rights/advocacy-and-self-advocacy) — Desarrollar habilidades de defensa
- [Raza y discapacidad](/es/intersectionality/race-and-disability) — El racismo médico y las personas racializadas con discapacidad
- [Género y discapacidad](/es/intersectionality/gender-and-disability) — La invalidación médica basada en el género
- [Enfermedad crónica](/es/conditions/chronic-illness) — Vivir con condiciones crónicas

---

Esta página pone en el centro los conocimientos de las personas con discapacidad y se basa en la organización liderada por personas con discapacidad a nivel global. Los pacientes con discapacidad y los académicos de los estudios sobre la discapacidad han desarrollado estos marcos a través de la experiencia vivida y el análisis riguroso. Para preguntas o para sugerir agregados, consulta [Cómo Contribuir](/es/start/contribute).
