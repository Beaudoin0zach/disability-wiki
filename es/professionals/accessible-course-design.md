---
title: Diseñar un curso accesible
description: Una guía práctica para personas docentes sobre cómo integrar el acceso en un curso o programa desde el inicio — modalidades, plazos flexibles, materiales accesibles y tratar las adaptaciones como un piso, no un techo.
published: true
...
## El acceso como diseño, no como excepción
...
- [Personas educadoras](/es/professionals/educators) — fundamentos del DUA y práctica en K–12
- [Educación superior](/es/education/higher-education)
- [La política de la discapacidad — Una ruta de lectura](/es/media/politics-of-disability-reading-list) — para listas de lectura de cursos
- [Modelos de la discapacidad](/es/foundations/disability-models)
- [Derechos y leyes](/es/rights)
