...
*Última revisión: junio de 2026. Esta es una situación cambiante: el estado de la escasez, las cuotas de la DEA y qué formulaciones están escasas cambian con frecuencia. Consulta las bases de datos de escasez en vivo de la [FDA](https://www.fda.gov/drugs/drug-safety-and-availability/drug-shortages) y de la [ASHP](https://www.ashp.org/drug-shortages/current-shortages) antes de basarte en cualquier afirmación específica sobre disponibilidad.*
...
Ningún truco resuelve por sí solo una escasez, pero estas son las palancas que la gente realmente usa. Los temas recurrentes en la orientación de expertos: **persistencia, flexibilidad y planificar con anticipación.**

### Búsqueda en farmacias
- **Llama antes de quedarte sin medicación**: telefonea primero; no andes manejando de un lado a otro.
...
Quien te receta puede cambiarte a algo que haya en existencia. Si alguna opción te conviene *a ti* es una decisión clínica. Descritas de manera neutral, sin dosis:
...
Conocer las reglas te ayuda a planificar. (Esta es la base federal; **los estados a menudo agregan reglas más estrictas**, así que tu farmacéutico es la autoridad para tu situación.)
...
- **Las farmacias de pedido por correo** (a menudo a través del seguro) a veces pueden suministrar cuando el comercio minorista no puede, pero las reglas de tiempo de la Lista II las hacen menos flexibles en un apuro: planifica con más anticipación.
...
**Un período sin medicación es difícil, y no es un fracaso personal.** El TDAH tiene base cerebral; si quedarte sin tu medicación hace que el trabajo y las tareas diarias sean más difíciles, eso es la medicación haciendo su trabajo, no una falta de esfuerzo. Sé amable contigo mismo y baja la vara donde puedas.
...
Es comprensible sentirse desesperado durante un período sin medicación. Pero comprar "Adderall" u otros estimulantes en **sitios en línea que no exigen receta, vendedores de redes sociales o cualquier fuente que no sea una farmacia es genuinamente peligroso.** La DEA ha advertido que las farmacias en línea ilegales envían **pastillas falsificadas hechas con fentanilo y metanfetamina**, disfrazadas de medicación real, y hay personas que han muerto. Estos sitios están construidos para parecer legítimos. La única medicación fiablemente segura es la que **receta un proveedor con licencia y dispensa una farmacia real y con licencia.** Si estás al final de tus opciones, sigue insistiendo con quien te receta y con tu farmacéutico, usa los recursos que aparecen más abajo y considera la telesalud a través de proveedores *con licencia*.

---

## Organizaciones y recursos

- **[CHADD](https://chadd.org/)**: importante organización sin fines de lucro sobre el TDAH; [orientación práctica sobre la escasez](https://chadd.org/attention-article/adhd-medication-shortages-what-to-know-and-do/) y apoyo.
- **[ADDA](https://add.org/)**: la principal organización sin fines de lucro centrada específicamente en **adultos** con TDAH; apoyo entre pares (peer) y recursos.
- **[FDA Drug Shortages](https://www.fda.gov/drugs/drug-safety-and-availability/drug-shortages)**: estado oficial actual de la escasez en EE. UU. ([base de datos con búsqueda](https://www.accessdata.fda.gov/scripts/drugshortages/Drugshortages.cfm): busca por el nombre del ingrediente activo, p. ej. "amphetamine").
- **[ASHP Drug Shortages](https://www.ashp.org/drug-shortages/current-shortages)**: rastreador orientado a farmacéuticos, a menudo más detallado que el de la FDA.
- **[DEA — Illegal Online Pharmacies](https://www.dea.gov/resources/illegal-online-pharmacies)**: por qué evitar las fuentes que no sean farmacias.
...
- [Gestionar los medicamentos en un mundo inaccesible](/es/daily-living/medication-management) · [Neurodivergencia](/es/conditions/neurodivergence)
- [Navegación del seguro](/es/healthcare/insurance-navigation) · [Salud mental](/es/healthcare/mental-health)
