...
description: 
published: true
date: 2026-06-05T20:17:24.520Z
tags: 
editor: markdown
dateCreated: 2026-01-07T20:01:49.523Z
---
...
Abuse is a **pattern of control** where someone uses power over you to cause harm. It is not:
...
**These factors make abuse more likely—NOT your fault:**
...
**Why it matters:**
Systemic abuse is the foundation that makes individual abuse possible. When the **system** says disabled people are burdens, when the **law** controls our bodies, when **policy** assumes we shouldn't exist—abusers operate in that context of permission.
...
**These patterns appear across all abuse types:**
...
**These are completely normal responses to abuse:**
...
Abuse often intersects with racism, xenophobia, homophobia, and transphobia. Systems that should protect you (police, immigration, healthcare) may be sources of abuse themselves.
...
In Western countries, abuse is sometimes framed as "private matter" not state intervention. This protects abusers. However, there are legal remedies (restraining orders, prosecution, custody changes) and community resources.
...
In many Global South countries, abuse is compounded by:
...
- **National Disabled Women's Network:** Disability-specific DV resources
...
- **Equality and Human Rights Commission (UK):** Disability rights resources
...
- **"Why Does He Do That?" by Lundy Bancroft:** Understanding abusive patterns (caution: contains disturbing examples)
