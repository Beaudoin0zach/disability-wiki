...
tags: 
editor: markdown
dateCreated: 2025-11-20T19:17:13.637Z
---
...
### Types of Mobility Aids in Detail
...
**Steps to take:**
1. Get written denial with reason
2. Review your coverage and criteria
3. Gather supporting documentation
4. Request peer-to-peer review (physician to insurance physician)
5. File formal appeal
6. Request external review if available
7. Contact state insurance commissioner if appropriate
8. Consider legal assistance for wrongful denials
...
- Public transit accessibility (see [Public Transit Rights](/transport/public-transit-rights))
...
**Related Pages:**
- [Driving and Adaptive Driving](/transport/driving-and-adaptive-driving)
