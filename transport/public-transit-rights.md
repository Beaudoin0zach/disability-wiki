...
description: The UN Convention on the Rights of Persons with Disabilities (CRPD) Article 9 requires accessible transportation systems that enable independent living…
published: true
...
### The Right to Accessible Transit
...
1. **Document the problem**: Date, time, location, vehicle number, driver badge if visible
2. **Report to the transit agency**: Most have accessibility complaint processes
3. **File an ADA complaint**: With the Federal Transit Administration (FTA) or Department of Justice
4. **Contact disability rights organizations**: They may be able to help
...
2. **Research specific transit systems** you need to use
3. **Connect with other disabled travelers** for tips
4. **Advocate for improvements** where possible
...
### "The elevator is always broken at my station"
...
### "Bus drivers won't lower the ramp for me"
...
### "I need to use transit but my city's system isn't accessible"
