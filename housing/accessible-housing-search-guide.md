...
- **Entrances**: Zero steps or ramps with maximum 1:12 slope (one inch rise per 12 inches length)
- **Doorways**: Minimum 32-inch clear opening width (36 inches ideal for comfortable wheelchair passage); all doors should have lever-style handles workable with minimal hand strength
- **Bathrooms**: Roll-in showers requiring 36x36 inches minimum clear space with no curb; grab bars supporting 250+ pounds; toilets 17-19 inches high
- **Kitchen**: 36-48 inches clear knee space under counters; accessible appliances; 60-inch turning circles for wheelchairs
- **Flooring**: Hard flooring (tile, wood, vinyl) preferable to carpeting for wheelchair accessibility; level transitions or beveled thresholds

**Sensory accessibility** for Deaf/hard-of-hearing residents includes:
- Visual fire alarms, amplified doorbells
- TV captions
- Internet connection adequate for video relay services
- Visual alerts for locks and thermostats

For blind/low-vision residents:
- High contrast between walls and trim
- Consistent, logical layout
- Smart home technology for voice control
- Accessible nearby public transportation
...
- Smart home technology for reminders
- Sensory-friendly features (controlled noise, predictable routines)
...
## Where are you? Find housing search tools and strategies for your location
...
### Section 8 voucher search and accessibility
...
### How to evaluate and verify accessibility claims

**Before viewing**: Call ahead with these questions:
- Was building constructed after March 13, 1991 (Fair Housing Act effective date)?
- Does it receive federal funding (HUD, tax credits, other)?
- How many units in building?
- What specific accessibility features present?
- Any accessible units currently available?
- Can you provide written descriptions or photos of accessibility features?
...
### Seven common housing search situations (US)
...
### Evaluating accessibility (Canada)
...
### Subsidy programs (varies by province)
...
**UK** (post-Brexit): See [United Kingdom](#united-kingdom) section below.
...
### How to search effectively in EU countries

1. **Contact local disability organizations** — They often maintain accessible housing lists and can advise on landlords accommodating accessibility requests
2. **Use standard property portals** and search for "accessible," "disabled," "wheelchair," "accessible bathroom," etc.
3. **Ask direct questions** about accessibility features when contacting landlords/agents
4. **Request information in writing** to document what landlords claim about accessibility
5. **Measure and verify** during viewings—don't rely on landlord descriptions

### Universal Design standards (EU)
...
### Evaluating accessibility (Australia)
...
### Challenges in global housing search
...
### Universal housing search strategies (applicable everywhere)

1. **Know your accessibility needs**: Understand exactly which features your disability requires
2. **Ask specific questions**: Don't accept vague "it's accessible" responses; ask about specific features
3. **Verify in writing**: Get landlord responses in writing to document claims
4. **Measure during viewings**: Bring measuring tape; don't rely on landlord descriptions
5. **Take photos/video**: Document what you see during viewings (with permission)
6. **Connect with disability organizations**: They have local knowledge and can advocate
7. **Document everything**: Dates, names, what was said, responses—useful if discrimination occurs
8. **Persist**: Housing search is frustrating everywhere; persistence often needed
...
## Practical Tips for Seven Common International Situations
