...
description: Institutions—nursing homes, psychiatric hospitals, group homes, developmental facilities, and other congregate settings—segregate disabled people from community life.
published: true
...
## Disability Justice Critique of Institutions
...
- Large numbers of unrelated people live together
- Staff (not chosen by residents) control daily routines, activities, and decisions
- Residents have limited choice about with whom they live, what they eat, when they wake/sleep, who visits
- Settings are segregated from community (not regular neighborhoods)
- Residents not involved in community employment, education, recreation, civic participation
...
**This differs from:**
- Independent living with chosen housemates
- Supported living in own home with hired support
- Host homes or small family-based care (when chosen and with real autonomy)
- Peer-supported housing where residents have control
...
## International Deinstitutionalization Frameworks
...
### UN Convention on Rights of Persons with Disabilities (CRPD) Article 19
...
1. Ensure disabled people have "opportunity to choose their place of residence and where and with whom they live on an equal basis with others"
2. Ensure "access to a range of in-home, residential and other community support services"
3. Ensure community services and facilities are "available on an equal basis, and responsive to needs of persons with disabilities"
...
- Be in community (not segregated)
- Enable community participation and integration
- Provide choice and control to residents
...
### Deinstitutionalization standards (global)
...
## Where are you? Find information about deinstitutionalization and alternatives in your location
...
### Rights if institutionalized (U.S.)
...
### Transitioning from institutions (U.S.)

1. **Contact disability rights organization** in your state for assistance
2. **Request person-centered planning** from institution or case manager
3. **Work with CIL (Center for Independent Living)** - ncil.org directory - for community housing and support assistance
4. **Apply for Medicaid HCBS waiver** if not already receiving services (state waiver, not entitlement; waitlists exist)
5. **Advocate for self-directed care** option within your state's Medicaid program
6. **Document institutional barriers** to autonomy; use this in advocacy/legal proceedings
7. **Connect with disability organizations** - ADAPT, ASAN, SABE - for collective advocacy and peer support

### ADAPT and institutional resistance
...
### Deinstitutionalization leaders (EU)
...
### Trans-institutionalization concern
...
### Rights and transitioning (EU varies by country)

**Contact your national disability organization** for country-specific information on:
- Institutional rights
- Legal framework for challenging institutionalization
- Community living alternatives available
...
### Rights and challenging institutionalization (UK)
...
1. **Contact Disability Rights UK** or local disability organization for assistance
2. **Work with local council social services** on community living transition
3. **Advocate for genuine supported living** (not group homes)
4. **Connect with disability organizations** for support and advocacy
...
### Rights and challenging institutionalization (Australia)
...
### Transitioning (Australia)

1. **Contact local disability organization** for assistance
2. **Work with NDIS planner** on community living transition
3. **Advocate for genuinely community-based SDA** if using SDA
4. **Document institutional barriers** to autonomy
5. **Connect with disability organizations** for support
...
### Universal strategies for addressing institutionalization

1. **Know your rights**: CRPD Article 19 applies universally—right to community living
2. **Connect with disability organizations**: Disability movements exist in every country; collective organizing powerful
3. **Document institutional barriers**: Use documentation in advocacy and legal proceedings
4. **Demand person-centered planning**: Transitions must be based on your preferences, not institutional convenience
5. **Connect internationally**: Disabled Peoples' International, SABE International coordinate global advocacy
6. **Support others transitioning**: Peer support and mentorship critical for successful transitions
7. **Organize collectively**: Individual advocacy limited; collective disability movements create systemic change
...
### Cooperative and peer-led housing
...
**Have information about deinstitutionalization efforts, community-based alternatives, or country-specific resources to contribute?** [Contribute to DisabilityWiki](/start/contribute)
