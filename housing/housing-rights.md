...
2. **Access to support** — governments must provide or ensure community services enabling independent living
3. **Community integration** — housing must be in integrated community settings, not segregated institutions
4. **Accessibility** — physical environments and services must be accessible
...
## Where are you? Find country-specific information
...
### State and local protections: sometimes stronger than federal
...
### Filing housing discrimination complaints (U.S. Federal Process)
...
### Resolving violations without formal complaint
...
### Accessible Canada Act (federal framework)
...
### Provincial protections and tenancy acts
...
### How to request accommodations and modifications (Canada)
...
- Deinstitutionalization and transition from institutions to community living
- Funding for community support services
- Accessible, affordable housing
- Protection from forced institutionalization
...
### Individual member state implementation
...
### How to address housing discrimination (EU)
...
### Home modifications: Disabled Facilities Grants (DFG)
...
### Housing discrimination complaints (UK)
...
- Disabled tenants have right to reasonable adjustments
- Service animals and assistance animals must be accommodated
...
### Housing discrimination complaints (Australia)
...
### Challenges in Global South and underrepresented regions

Common barriers to housing rights implementation globally:
- **Resource constraints**: Limited government funding for community services
- **Institutional entrenchment**: Institutions (nursing homes, group homes) are established; financial interests protect them
- **Informal economy**: Large informal sectors mean formal housing protections don't apply to majority
- **Informal settlements**: Over 1 billion people live in informal settlements globally; disabled people face compounded barriers
- **Enforcement gaps**: Laws exist but are rarely enforced; complaint mechanisms are inadequate
- **Intersectional discrimination**: Disabled people of color, disabled LGBTQ+ people, disabled immigrants, disabled women, disabled Indigenous people face compounded barriers

### Disability-led organizing globally
...
### Finding housing rights resources in your country

1. **Search for your country + "disability rights organization"** or "disabled people's organization"
2. **Contact your national human rights institution** (most countries have national human rights commissions)
3. **Search CRPD implementation**: Your country's progress report to UN Committee on CRPD documents what laws exist
4. **Connect internationally**: DPI, SABE International, and regional networks can connect you with organizations in your country

---

## Key Principles Applied Across All Legal Systems
...
## Using These Frameworks in Your Context
...
1. **Know the international standard**: Article 19 establishes your right to live independently in community with support. This applies universally regardless of your government's CRPD status.

2. **Understand your national laws**: Use this page to find country-specific information about what rights exist in your country and how to enforce them.

3. **Connect globally**: Disabled people worldwide are organizing. International disability networks, regional organizations, and global solidarity strengthen local advocacy.

4. **Document violations**: If your government violates CRPD obligations, document them. Evidence supports advocacy, litigation, and international accountability mechanisms.

5. **Organize collectively**: Disabled people's organizations are powerful. If one doesn't exist in your area, others exist regionally and globally, and may support your local organizing.
...
**Have housing rights resources, research, or country-specific information to contribute?** [Contribute to DisabilityWiki](/start/contribute)
