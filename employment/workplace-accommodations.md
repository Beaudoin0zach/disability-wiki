...
1. **Discuss your needs**: What barriers are you experiencing?
2. **Identify possible accommodations**: There may be multiple solutions
3. **Consider effectiveness**: Will the accommodation work?
4. **Implement the accommodation**: Put it in place
5. **Follow up**: Is it working? Adjust if needed
...
2. **Propose alternatives**: There may be other solutions
3. **Escalate internally**: HR, supervisor's manager
4. **File a complaint**: EEOC (US), human rights commission (other countries)
5. **Seek legal help**: Disability rights attorneys, protection and advocacy organizations
